    ...
    <section class="domain-section" id="domain-terdaftar">
        <div class="container">
            ...
            <div class="table-footer-action">
                ...
                <a href="<?php echo e($domains->nextPageUrl()); ?>#domain-terdaftar" class="btn btn-secondary-action btn-next-page" style="text-decoration: none; display: inline-flex; align-items: center; justify-content: center;">
                    Selanjutnya &rarr;
                </a>
                <?php else: ?>
