...
<?php $__env->startSection('content'); ?>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-info-group">
                ...
                <span class="stat-value"><?php echo e(number_format($totalDesa)); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="admin-card" style="margin-top: 28px;">
        <div class="chart-card-header">
            ...
            <a href="<?php echo e(route('admin.pengajuan.index')); ?>" class="btn-action-primary">Kelola Semua Pengajuan</a>
        </div>

        <?php if($recentPengajuans->isEmpty()): ?>
        ...
        <?php else: ?>
            <div style="overflow-x: auto;">
                <table class="custom-table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $recentPengajuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pengajuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($index + 1); ?></td>
                                <td><strong><?php echo e($pengajuan->desa->nama_desa ?? '-'); ?></strong></td>
                                <td><?php echo e($pengajuan->desa->kecamatan ?? '-'); ?></td>
                                <td><?php echo e(\Carbon\Carbon::parse($pengajuan->tanggal_pengajuan)->translatedFormat('d F Y H:i')); ?></td>
                                <td>
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.pengajuan.show', $pengajuan->id_pengajuan)); ?>" class="btn-action-secondary">
                                        Periksa Detail
                                    </a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\sideka-ng\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>