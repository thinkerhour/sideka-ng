<?php $__env->startSection('title', 'Tambah Data Desa'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="admin-card" style="max-width: 720px;">
        ...
        <form action="<?php echo e(route('admin.desa.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 18px;">
                <div>
                    ...
                    <input type="text" name="nama_desa" value="<?php echo e(old('nama_desa')); ?>" required placeholder="Contoh: Ciburuy" style="width: 100%; padding: 10px 14px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px;">
                </div>
                <div>
                    ...
                    <input type="text" name="kecamatan" value="<?php echo e(old('kecamatan')); ?>" required placeholder="Contoh: Padalarang" style="width: 100%; padding: 10px 14px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px;">
                </div>
            </div>
            ...
            <div style="margin-bottom: 18px;">
                ...
                <input type="text" name="nama_kepala_desa" value="<?php echo e(old('nama_kepala_desa')); ?>" required placeholder="Contoh: H. Ahmad Supardi" style="width: 100%; padding: 10px 14px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px;">
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 18px;">
                <div>
                    ...
                    <input type="text" name="nama_admin_website" value="<?php echo e(old('nama_admin_website')); ?>" required placeholder="Contoh: Budi Santoso" style="width: 100%; padding: 10px 14px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px;">
                </div>
                <div>
                    ...
                    <input type="text" name="no_telp_admin" value="<?php echo e(old('no_telp_admin')); ?>" required placeholder="Contoh: 081234567890" style="width: 100%; padding: 10px 14px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px;">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 24px;">
                <div>
                    ...
                    <input type="email" name="email_admin" value="<?php echo e(old('email_admin')); ?>" required placeholder="admin@ciburuy.desa.id" style="width: 100%; padding: 10px 14px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px;">
                </div>
                <div>
                    <label style="display: block; font-size: 13.5px; font-weight: 700; color: #1e293b; margin-bottom: 6px;">URL Website (Opsional)</label>
                    <input type="url" name="website" value="<?php echo e(old('website')); ?>" placeholder="https://ciburuy.desa.id" style="width: 100%; padding: 10px 14px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px;">
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\sideka-ng\resources\views/admin/desa/create.blade.php ENDPATH**/ ?>