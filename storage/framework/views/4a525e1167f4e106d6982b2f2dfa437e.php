...
<?php $__env->startSection('content'); ?>
    <div style="margin-bottom: 24px;">
        <a href="<?php echo e(route('admin.desa.index')); ?>" class="btn-action-secondary" style="display: inline-flex; align-items: center; gap: 8px; margin-bottom: 12px; text-decoration: none; font-weight: 700; font-size: 13.5px; padding: 8px 16px; border-radius: 8px;">
    ...
    <div class="admin-card">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 24px;">
            ...
            <div>
                ...
                <div style="font-size: 15px; font-weight: 700; color: #0284c7;"><?php echo e($desa->email_admin); ?></div>
            </div>
            <div>
            ...
            <div>
                ...
                <div>
                    <?php if($desa->website): ?>
                        <a href="<?php echo e($desa->website); ?>" target="_blank" style="color: #0284c7; font-weight: 700; text-decoration: none;"><?php echo e($desa->website); ?></a>
                    <?php else: ?>
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; padding: 16px; background: #f8fafc; border-radius: 12px; border: 1px solid #e2e8f0;">
                <div>
                    <div style="font-size: 14.5px; font-weight: 700; color: #0f172a;">
                        Diajukan pada: <?php echo e(\Carbon\Carbon::parse($desa->pengajuan->tanggal_pengajuan)->locale('id')->isoFormat('D MMMM YYYY, HH:mm')); ?> WIB
                    </div>
