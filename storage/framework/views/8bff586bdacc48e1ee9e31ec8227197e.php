...
<?php $__env->startSection('content'); ?>
    ...
    <div class="charts-grid" style="margin-bottom: 28px;">
        ...
        <div class="admin-card">
            <div class="chart-card-header">
                <h2 class="chart-card-title">Cakupan Desa Berdomain (<?php echo e($totalDesa > 0 ? round(($desaBerdomain / $totalDesa) * 100, 1) : 0); ?>%)</h2>
            </div>
            <div style="height: 320px; position: relative;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px;">
            ...
            <div style="padding: 16px; background: #f8fafc; border-radius: 12px; border: 1px solid #e2e8f0;">
                ...
                <div style="font-size: 22px; font-weight: 800; color: #3b82f6; margin-top: 4px;">
                    <?php echo e($totalPengajuan > 0 ? round(($pengajuanDiproses / $totalPengajuan) * 100, 1) : 0); ?>%
                </div>
            ...
            <div style="padding: 16px; background: #f8fafc; border-radius: 12px; border: 1px solid #e2e8f0;">
                ...
                <div style="font-size: 22px; font-weight: 800; color: #f59e0b; margin-top: 4px;">
                    <?php echo e($totalPengajuan > 0 ? round(($pengajuanRevisi / $totalPengajuan) * 100, 1) : 0); ?>%
                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        new Chart(ctxCakupan, {
            type: 'pie',
            data: {
                labels: ['Sudah Memiliki Domain (<?php echo e($desaBerdomain); ?>)', 'Belum Memiliki Domain (<?php echo e($desaBelumDomain); ?>)'],
                datasets: [{
                    data: [<?php echo e($desaBerdomain); ?>, <?php echo e($desaBelumDomain); ?>],
