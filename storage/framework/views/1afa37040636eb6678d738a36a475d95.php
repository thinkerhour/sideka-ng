                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($pengajuan->desa): ?>
                                        <strong><?php echo e($pengajuan->desa->nama_desa); ?></strong>
                                    <?php else: ?>
                                        <span style="display: inline-block; padding: 2px 8px; font-size: 11.5px; font-weight: 700; color: #b45309; background: #fef3c7; border: 1px solid #fde68a; border-radius: 4px;">
                                            Belum Ditautkan
                                        </span>
                                    <?php endif; ?>
                                </td>
