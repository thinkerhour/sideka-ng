    ...
    <main class="hero-section">
        <div class="container hero-container">
            <div class="hero-content">
                <h1 class="hero-title">
                    Pengajuan Sistem Informasi Desa dan Kawasan New Generation
                </h1>
                ...
                <div class="hero-cta">
                    <button class="btn-ajukan-pill" id="btn-ajukan-sideka" type="button" aria-label="Ajukan SIDeKa-NG">
                        <span>Ajukan SIDEKA-NG</span>
...
<div class="modal-backdrop" id="modal-konfirmasi">
    <div class="modal-card modal-card-small">
        <div class="modal-header modal-header-clean">
            <div></div>
            <button class="modal-close-btn" data-close-modal aria-label="Tutup">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#64748b" stroke-width="2.8" stroke-linecap="round" stroke-linejoin="round">
                    <line x1="18" y1="6" x2="6" y2="18"></line>
                    <line x1="6" y1="6" x2="18" y2="18"></line>
                </svg>
            </button>
